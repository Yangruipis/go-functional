...
| progress[51/51] | func        | signature                          | type                 |
|-----------------+-------------+------------------------------------+----------------------|
...
| [X]             | Zip         | [T1, T2] [T1, O2]-> [T1, [T2, O2]] | transformation       |
...
| [X]             | Head        | [T1, T2] -> [T1, T2]               | transformation       |
| [X]             | Tail        | [T1, T2] -> [T1, T2]               | transformation       |
| [X]             | Repeat      | T -> [int, T]                      | transformation(init) |
| [X]             | Range       | int -> [int, int]                  | transformation(init) |
| [X]             | Reduce      | [T1, T2] -> O                      | action               |
| [X]             | Size        | [T1, T2] -> int                    | action               |
| [X]             | Exists      | [T1, T2] -> bool                   | action               |
| [X]             | ExistsBy    | [T1, T2] -> bool                   | action               |
| [X]             | All         | [T1, T2] -> bool                   | action               |
| [X]             | Any         | [T1, T2] -> bool                   | action               |
| [X]             | Count       | [T1, T2] -> int                    | action               |
| [X]             | CountBy     | [T1, T2] -> int                    | action               |
| [X]             | ToSlice     | [T1, T2] -> []T2                   | action               |
| [X]             | ToMap       | [T1, T2] -> map[T1]T2              | action               |
| [X]             | ToSet       | [T1, T2] -> map[T1]struct{}        | action               |
| [X]             | Sum         | [T1, T2] -> int                    | action               |
| [X]             | Avg         | [T1, T2] -> int                    | action               |
| [X]             | ForEach     | [T1, T2] ->                        | action               |
| [X]             | Contains    | [T1, T2] -> bool                   | action               |
| [X]             | IndexOf     | [T1, T2] -> []int                  | action               |
| [X]             | NIndexOf    | [T1, T2] -> int                    | action               |
